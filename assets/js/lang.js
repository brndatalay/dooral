...
(function () {
    ...
    function initButtonPicker(picker) { // create the button element -> picker trigger
        ...
        button = button + '<span style="color: '+textColor+' !important;" aria-hidden="true" class="language-picker__label language-picker__flag language-picker__flag--' + picker.select.value + '"><em style="color: '+textColor+' !important;">' + picker.selectedOption + '</em>';
    ...
    function initListPicker(picker) { // create language picker dropdown
        ...
        for (var i = 0; i < picker.options.length; i++) {
            ...
            list = list + '<li><a style="color: black !important;" lang="' + language + '" hreflang="' + language + '" href="' + getLanguageUrl(picker.options[i]) + '"' + selected + ' role="option" data-value="' + picker.options[i].value + '" class="language-picker__item language-picker__flag language-picker__flag--' + picker.options[i].value + '"><span>' + picker.options[i].text + '</span></a></li>';
        }
        ;
        return list;
    };
