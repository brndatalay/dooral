...
<div class="slider">
    <div class="owl-carousel owl-theme main-slider">
        <div class="item">
            <img src="<?= $domain ?>assets/images/slider-1.jpg" alt="">
            <div class="caption" data-animation-in="fadeInLeft">
                <h3 class="animated bounce">First Caption</h3></div>
        </div>
        <div class="item">
            <img src="<?= $domain ?>assets/images/slider-2.jpg" alt="">
            <div class="caption" data-animation-in="fadeInLeft">
                <h3 class="">Second Caption</h3></div>
        </div>
        <div class="item">
            <img src="<?= $domain ?>assets/images/slider-3.jpg" alt="">
            <div class="caption" data-animation-in="fadeInLeft">
                <h3 class="">Fourth Caption</h3></div>
        </div>
    </div>
</div>
<!-- End Carousel -->
