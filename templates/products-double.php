...
$products=mysqli_fetch_all(mysqli_query($db,"SELECT * FROM product where type='3'"),MYSQLI_ASSOC);
...
<div class="page-header tasarim">
    ...
    <div class="main">
        ...
        <div class="menu">
            ...
            <a class="active" href="<?= $domain ?>products-double"><img src="<?= $domain ?>assets/images/door-bt-3.png" alt=""><?= $menu[4] ?></a>
        </div>
    </div>
</div>
<div class="products">
